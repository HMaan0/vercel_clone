    ...
    <>
      <div className="flex xl:flex-row flex-col justify-center items-center gap-2 xl:px-0 sm:px-0 md:px-20">
        ...
        <div className="xl:w-full lg:w-3/4 w-full flex  flex-col border border-border-theme rounded-2xl shadow ">
          <div className="rounded-t-2xl border-b border-border-theme w-full relative bg-light-bg p-2">
            ...
            <div className="sm:flex hidden absolute text-sm left-15 -bottom-[0.5px] justify-between items-center gap-2 border border-border-theme border-b-white bg-white rounded-t-xl w-fit px-2 p-1 text-text-theme">
